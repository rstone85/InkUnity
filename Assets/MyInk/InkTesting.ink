...
* [Start working on the project] -> start_project
* [Chat with a coworker] -> chat_with_coworker
+ -> //fallback choice
...
+ [Break down the task into smaller parts] -> break_down_task
+ [Try to power through without a plan] -> no_plan
...
+ [Eat in the lunch room with co-workers] -> lunch_with_coworkers
+ [Eat lunch at desk and continue working] -> lunch_at_desk
+ [Go out for lunch] -> lunch_outside
...
+ [Push through and work hard] -> push_through
+ [Get another coffee] -> coffee_break
...
+ [Relax at home] -> next_day
+ [Go out with friends] -> next_day
